...
export interface GetUser_user_posts_projectExecution {
...
export interface GetUser_user_posts_comments_user_profilePic {
  __typename: "Image";
  hostedUrl: string;
}

export interface GetUser_user_posts_comments_user {
  __typename: "User";
  firstName: string | null;
  lastName: string | null;
  username: string;
  ...
  bio: string | null;
  id: string;
  profilePic: GetUser_user_posts_comments_user_profilePic | null;
}

export interface GetUser_user_posts_comments {
  __typename: "Comment";
  id: string;
  createdAt: any;
  text: string;
  postId: string;
  userId: string;
  user: GetUser_user_posts_comments_user;
}
