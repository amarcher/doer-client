...
export default function ImageUploadThumbnail({ id, percent, src = '', onDeletePhoto, width = 500, height = 500 }: Props) {
	return (
		<div className="ImageUploadThumbnail">
			{onDeletePhoto && (<Button preventDefault onPress={() => onDeletePhoto(id)} className="ImageUploadThumbnail__button">x</Button>)}
